        ...
        <div class="container">
            <div class="row">
              ...
              <div class="col-md-8">
                ...
                -->
                <div>
                    <h3 style="font-family: 'Cuprum', sans-serif; color: #1E824C;"><i class="fa fa-life-ring"></i>&nbsp;&nbsp;Deposit</h3>
                </div>
                <div class="jumbotron">
                    <form class="form-inline">
                        ...
                        <span class="label label-default nc">Deposit Book Number&nbsp;:&nbsp;</span>
                        &nbsp;
                        &nbsp;
                        </br>
                        </br>
                        ...
                        <span class="label label-default nc">Deposit Type&nbsp;:&nbsp;</span>
                        &nbsp;
                        &nbsp;
                        <div class="form-group inp">
                          <input type="checkbox" aria-label="time">&nbsp;&nbsp;Time Deposit&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        </div>
                        <div class="form-group inp">
                          <input type="checkbox" aria-label="call">&nbsp;&nbsp;Call Deposit&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        </div>
                        </br>
                        </br>
                        <span class="label label-default nc">Duration Type (Months)&nbsp;:&nbsp;</span>
                        &nbsp;
                        &nbsp;
                        </br>
                        </br>
