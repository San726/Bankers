        ...
        <div class="container">
            <div class="row">
              ...
              <div class="col-md-8">
                ...
                -->
                <div>
                    <h3 style="font-family: 'Cuprum', sans-serif; color: #1E824C;"><i class="fa fa-wheelchair"></i>&nbsp;&nbsp;Loan</h3>
                </div>
                <div class="jumbotron">
                    <form class="form-inline">
                        ...
                        <span class="label label-default nc">Loan No&nbsp;:&nbsp;</span>
                        &nbsp;
                        &nbsp;
                        </br>
                        </br>
                        <div class="form-group inp">
                            <input type="text" style="width:250%"class="form-control " id="exampleInputName2" placeholder="type your Loan No. here .....">
                        </div>
                        </br>
                        </br>
                        <span class="label label-default nc">Loan Type&nbsp;:&nbsp;</span>
                        </br>
                        </br>
                        <div class="form-group inp">
                          <input type="checkbox" aria-label="time">&nbsp;&nbsp;House Loan&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        </div>
                        <div class="form-group inp">
                          <input type="checkbox" aria-label="call">&nbsp;&nbsp;Car Loan&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        </div>
                        <div class="form-group inp">
                          <input type="checkbox" aria-label="time">&nbsp;&nbsp;Business Loan&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        </div>
                        <div class="form-group inp">
                          <input type="checkbox" aria-label="call">&nbsp;&nbsp;Student Loan&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        </div>
                        </br>
                        </br>
                        ...
                        <div class="form-group inp">
                            <input type="text" style="width:250%"class="form-control " id="exampleInputName2" placeholder="type Branch No here .....">
                        </div>
                        </br>
                        </br>
                        </br>
                        </br>
                        <button type="button" class="btn btn-warning">Take Loan!</button>
                    </form>
                </div>
              </div>
            </div>
